...
namespace Insperex.EventHorizon.EventStore.ElasticSearch.Extensions
{
    ...
    {
        public static EventHorizonConfigurator UseElasticSnapshotStore<TState>(this EventHorizonConfigurator configurator, Action<ElasticConfig> onConfig = null)
            where TState : IState
        {
        ...
        public static EventHorizonConfigurator UseElasticViewStore<TState>(this EventHorizonConfigurator configurator, Action<ElasticConfig> onConfig = null)
            where TState : IState
        {
